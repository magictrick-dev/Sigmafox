...
enum class SymbolobjectClassification
{
    SYMBOL_CLASS_NULL,
...
class Symbolobject
{
    ...
    protected:
        ...
        SymbolobjectClassification classification;
...
{
    SYMBOL_CLASS_UNDEFINED,
    SYMBOL_CLASS_INTEGER,
    SYMBOL_CLASS_REAL,
    SYMBOL_CLASS_COMPLEX,
    SYMBOL_CLASS_STRING,
};
